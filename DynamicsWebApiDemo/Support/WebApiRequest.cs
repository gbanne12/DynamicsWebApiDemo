...
namespace DynamicsWebApiDemo.Support
{
    internal class WebApiRequest
    {
        ...
        /// </summary>
        /// <param name="config">values from appsettings.json</param>
        ...
        public static async Task<HttpResponseMessage> SendMessageAsync(
            WebApiConfiguration config, HttpMethod httpMethod, string messageUri, string messageBody = null)
        {
        ...
        private static async Task<string> GetAccessToken(WebApiConfiguration webConfig)
        {
